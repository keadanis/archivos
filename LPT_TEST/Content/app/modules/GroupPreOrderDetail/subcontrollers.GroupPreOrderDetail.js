    ...
    .controller('PreOrderPrintCtrl', ['$injector', '$scope', '$routeParams','$window', 'PreOrderResource', 'PreOrderKey', 'PreOrderFilters', 'PreOrderParams', 'EventsEditDetail', 'sharedModal',
        ...
        function ($injector, $scope, $routeParams,$window,$timeout,$filter, ApiResource, ApiKey, ApiFilters, ApiParameters, Events, sharedModal) {
            ...
            $scope.returnComment = function(pOrder,idSchool){
                ...
                return "Los paquetes están conformados por las 4 materias básicas, correspondientes a cada nivel. Los productos complementarios son gratuitos para los docentes. Una vez que se nos proporcionan los datos de los docentes, se les brinda el código para acceder al Club Docente. La donación del producto entregado representa el monto de " + totalPrint ;
            }
